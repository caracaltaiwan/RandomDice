...
module games::drand_based_lottery_tests {
    ...
    use games::drand_based_lottery::{Self, Game, Ticket, GameWinner, GameOwnerCapability};
    ...
    fun test_play_drand_dice() {
        ...
        drand_based_lottery::init_for_testing(test_scenario::ctx(scenario));
        profits_pool::init_for_testing(test_scenario::ctx(scenario));
        
        //Create game, code equivalent : drand_based_lottery::create(10, test_scenario::ctx(scenario));
        drand_based_lottery::create_after_round(&clock, 9, test_scenario::ctx(scenario));
        test_scenario::next_tx(scenario, user1);
        ...
        // User1 buys a ticket.
        test_scenario::next_tx(scenario, user1);
        drand_based_lottery::participate(game, coin::mint_for_testing<SUI>(10, test_scenario::ctx(scenario)), test_scenario::ctx(scenario));
        // User2 buys a ticket.
        ...
        drand_based_lottery::redeem(&ticket, game, test_scenario::ctx(scenario));
        ...
        test_scenario::next_tx(scenario, user1);
        drand_based_lottery::collect_profits(&cap, game, pool, &mut ctx);
